var level0State = {
    create: function() { 
        ...
        this.ground9 = this.walls.create(-100, 500, 'floor');
        ...
        this.ground5 = this.walls.create(0, 500, 'floor');
        this.ground6 = this.walls.create(550, 400, 'floor');
        this.ground7 = this.walls.create(400, 0, 'ceiling');
        this.ground8 = this.walls.create(400, 115, 'floor');
        ...
        this.ground5.scale.x = 0.75;
        this.ground5.scale.y = 4;
        this.ground6.scale.x = 2;
        this.ground6.scale.y = 8;
        //this.ground7.scale.x = 2;
        this.ground7.scale.y = 0.35;
        this.ground8.scale.x = 0.3;
        //this.ground8.scale.y = 8;
        
        this.switch1 = this.switches.create(430, 35, 'switch');
        this.switchOn1 = false;
        
        this.door = game.add.sprite(925, 330, 'door');
        this.door.animations.add('doorOpen', [0, 1, 2, 3], 64, false);
        this.door.animations.add('doorClose', [3, 2, 1, 0], 64, false);
        
        this.instructions1 = game.add.text(60, 50, 'WASD: Move and Jump', { fontSize: '25px', fill: '#ffffff'});
        this.instructions2 = game.add.text(60, 80, 'Mouse: Aim and Shoot', { fontSize: '25px', fill: '#ffffff'});
        this.instructions3 = game.add.text(60, 110, 'R: Restart Level', { fontSize: '25px', fill: '#ffffff'});
    ...
    update: function() {
        ...
        if (this.ground9.x >= 175 && this.switchOn1 == true){
            this.ground9.body.velocity.x = 0;
        }
        
        if (this.switchOn1 == false){
            this.ground9.body.velocity.x = -30;
        }
        
        if (this.ground9.x <= -100 && this.switchOn1 == false){
            this.ground9.body.velocity.x = 0;
        }
    ...
    */
    ...
    activateSwitch1: function(){
        ...
        if (this.switchOn1 == false){
            ...
            ////console.log("Activate Switch");
            this.ground9.body.velocity.x = 40;
        }
    },
