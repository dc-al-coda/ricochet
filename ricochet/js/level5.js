...
var level5State = {
    create: function() { 
        ...
        this.ground4 = this.walls.create(0, 0, 'absorbfloor');
        this.ground3 = this.walls.create(500, 600, 'floor');
        
        this.ground5 = this.walls.create(0, 400, 'absorbfloor')
        this.ground6 = this.walls.create(616, 400, 'floor');
        this.rotatingPlatform = this.walls.create(400, 400, 'floor');
        this.rotatingPlatform.scale.x = 0.6;
        this.ground7 = this.walls.create(800, 225, 'floor');
        this.ground7.scale.x = 0.6;
        this.ground8 = this.walls.create(475, 520, 'floor');
        this.ground8.scale.x = 0.2;
        this.ground8.scale.y = 5;
        
        this.deathLaser1 = this.deathLasers.create(0, 600, 'deathLaserH');
        this.deathLaser1.scale.x = 1.19;
        
        this.switch1 = this.switches.create(16, 500, 'switch');
        this.switch1.frame = 0;
        this.switchOn1 = false;
        
        this.door = game.add.sprite(16, 328, 'door');
        ...
        this.player = this.game.add.sprite(900, 540, 'rick');
        ...
        this.enemy1 = this.enemies.create(845, 150, 'enemy');
        ...
        this.enemy2 = this.enemies.create(730, 325, 'enemy');
        this.enemy2.frame = 0;
        ...
        this.enemy3 = this.enemies.create(260, 320, 'enemy');
        this.enemy3.frame = 0;
        ...
        this.blockingWalls = [
            ...
            this.blockingWall5 = new Phaser.Line(this.rotatingPlatform.x, this.rotatingPlatform.y, this.rotatingPlatform.x+this.rotatingPlatform.width, this.rotatingPlatform.y),
            ];
    ...
    activateSwitch1: function(){
        ...
        if (this.switchOn1 == false){
            ...
            this.bullet.kill();
            this.switchOn1 = true;
            var tween = game.add.tween(this.rotatingPlatform).to( { angle: 90 }, 2000, Phaser.Easing.Linear.None, true);
            tween.onComplete.add(this.changePlatform, this);
    ...
    changePlatform: function(){
         if (this.switchOn1 == true){
            this.rotatingPlatform.kill();
            this.rotatingPlatform = this.walls.create(368, 400, 'ceiling');
            this.rotatingPlatform.scale.y = 0.6;
            this.rotatingPlatform.enableBody = true;
            this.rotatingPlatform.physicsBodyType = Phaser.Physics.ARCADE;
            this.rotatingPlatform.body.immovable = true;
            this.rotatingPlatform.body.allowGravity = false;
         }
    },
