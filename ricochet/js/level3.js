var level3State = {
    create: function() { 
        ...
        this.elevators1 = game.add.group();
        this.elevators2 = game.add.group();
        ...
        this.ground5 = this.walls.create(16, 146, 'floor');
        this.ground5.scale.x = 0.6;
        
        this.ground6 = this.walls.create(634, 0, 'ceiling');
        this.ground6.scale.y = 0.8;
        
        this.ground7 = this.walls.create(880, 285, 'floor');
        this.ground7.scale.x = 0.3;
        
        this.ground8 = this.walls.create(665, 191, 'floor');
        this.ground8.scale.x = 0.35;
        
        this.ground9 = this.walls.create(880, 100, 'floor');
        this.ground9.scale.x = 0.3;
        
        this.elevator1 = this.elevators1.create (-400, 380, 'movingPlatform');
        this.elevator1.scale.x = 1;
        
        this.elevatortwo1 = this.elevators2.create(437, 145, 'floor');
        this.elevatortwo1.scale.x = 0.5;
        this.elevatortwo2 = this.elevators2.create(437, 16, 'floor');
        this.elevatortwo2.scale.x = 0.25;
        this.elevatortwo3 = this.elevators2.create(406, 16, 'ceiling');
        this.elevatortwo3.scale.y = 0.402;
        this.elevatortwo4 = this.elevators2.create(437, 77, 'floor');
        this.elevatortwo4.scale.x = 0.1;
        
        this.switch1 = this.switches.create(895, 131, 'switch');
        this.switch1.frame = 0;
        this.switch2 = this.switches.create(475, 77, 'switch');
        this.switch2.frame = 0;
        
        this.deathLaser1 = this.deathLasers.create(16, 500, 'deathLaserH');
        this.deathLaser1.scale.x = 2.46;
        this.deathLaser1.scale.y = 2;
        this.deathLaser1.animations.add('active', [0, 1, 2, 3, 4, 5], 32, true);
        this.deathLaser1.alpha = 0.75;
        
        this.door = game.add.sprite(940, 28, 'door');
        this.door.animations.add('doorOpen', [0, 1, 2, 3], 64, false);
        this.door.animations.add('doorClose', [3, 2, 1, 0], 64, false);
        
        this.player = this.game.add.sprite(20, 20, 'rick');
        ...
        game.physics.arcade.enable(this.elevators1);
        game.physics.arcade.enable(this.elevators2);
        ...
        //elevators
        this.elevators1.enableBody = true;
        this.elevators1.physicsBodyType = Phaser.Physics.ARCADE;
        this.elevators1.setAll('body.immovable', true);
        this.elevators1.setAll('body.allowGravity', false);
        
        //elevators
        this.elevators2.enableBody = true;
        this.elevators2.physicsBodyType = Phaser.Physics.ARCADE;
        this.elevators2.setAll('body.immovable', true);
        this.elevators2.setAll('body.allowGravity', false);
    ...
    update: function() {
        ...
        this.game.physics.arcade.collide(this.player, this.elevators1);
        this.game.physics.arcade.collide(this.player, this.elevators2);
        this.game.physics.arcade.collide(this.bullets, this.elevators1, this.hitWall, null, this);
        this.game.physics.arcade.collide(this.bullets, this.elevators2, this.hitWall, null, this);
        ...
        if (this.elevatortwo1.y >= 285 && this.switchOn1 == true){
            for (i = 0; i < this.elevators2.children.length; i++){
                this.elevators2.children[i].body.velocity.y = 0;
                this.switch2.body.velocity.y = 0;
            }
        }
        
        if (this.elevatortwo1.y >= 285 && this.switchOn1 == false){
            for (i = 0; i < this.elevators2.children.length; i++){
                this.elevators2.children[i].body.velocity.y = -20;
                this.switch2.body.velocity.y = -20;
            }
        }

        if (this.elevatortwo1.y <= 145 && this.switchOn1 == false){
            for (i = 0; i < this.elevators2.children.length; i++){
                this.elevators2.children[i].body.velocity.y = 0;
                this.switch2.body.velocity.y = 0;
            }
        ...
        if (this.elevatortwo1.y >= 145 && this.elevatortwo1.y <= 285 && this.switchOn2 == true){
            for (i = 0; i < this.elevators2.children.length; i++){
                this.elevators2.children[i].body.velocity.y = 0;
                this.switch2.body.velocity.y = 0;
            }
        ...
        if (this.elevatortwo1.y >= 145 && this.elevatortwo1.y <= 285 && this.switchOn1 == false && this.switchOn2 == false){
            for (i = 0; i < this.elevators2.children.length; i++){
                this.elevators2.children[i].body.velocity.y = -20;
                this.switch2.body.velocity.y = -20;
            }
        ...
        if (this.elevator1.x >= 600 && this.switchOn2 == true){
            this.elevator1.body.velocity.x = 0;
        }
        
        if (this.elevator1.x > -400 && this.elevator1.x <= 700 && this.switchOn2 == false){
            this.elevator1.body.velocity.x = -20;
        }
        
        
        if (this.elevator1.x <= -400 && this.switchOn2 == false){
            this.elevator1.body.velocity.x = 0;
        }
    ...
    */
    ...
    activateSwitch1: function(){
        ...
        if (this.switchOn1 == false){
            ...
            for (i = 0; i < this.elevators2.children.length; i++){
                this.elevators2.children[i].body.velocity.y = 50;
                this.switch2.body.velocity.y = 50;
            }
        }
    },
    ...
    activateSwitch2: function(){
        ...
        if (this.switchOn2 == false){
            ...
            this.switchOn2 = true;
            this.switchOnSound.play();
            this.elevator1.body.velocity.x = 50;
            game.add.tween(this.arpeggio).to({volume:1}, 1000).start();
        }
    },
