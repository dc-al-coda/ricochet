var level4State = {
    create: function() { 
        ...
        this.ground5 = this.walls.create(16, 200, 'floor');
        this.ground5.scale.x = 0.3;
        
        this.ground6 = this.walls.create(16, 420, 'floor');
        this.ground6.scale.x = 0.3;
        
        this.ground7 = this.walls.create(880, 200, 'floor');
        this.ground7.scale.x = 0.3;
        
        this.ground8 = this.walls.create(880, 380, 'floor');
        this.ground8.scale.x = 0.3;
        
        this.ground9 = this.walls.create(200, 100, 'floor');
        this.ground9.scale.x = 0.3;
        
        this.ground10 = this.walls.create(200, 300, 'floor');
        this.ground10.scale.x = 0.3;
        
        this.ground11 = this.walls.create(200, 480, 'floor');
        this.ground11.scale.x = 0.3;
        
        this.ground12 = this.walls.create(400, 345, 'floor');
        this.ground12.scale.x = 0.5;
        
        this.ground13 = this.walls.create(675, 95,'floor');
        this.ground13.scale.x = 0.3;
        
        this.ground14 = this.walls.create(295, 195, 'floor');
        this.ground14.scale.x = 0.3;
        
        this.ground15 = this.walls.create(575, 195, 'floor');
        this.ground15.scale.x = 0.3;
        
        this.ground16 = this.walls.create(675, 300, 'floor');
        this.ground16.scale.x = 0.3;
        
        this.ground17 = this.walls.create(675, 480, 'floor');
        this.ground17.scale.x = 0.3;
        
        this.ground18 = this.walls.create(400, 16, 'ceiling');
        this.ground18.scale.y = 0.525;
        
        this.ground19 = this.walls.create(566, 16, 'ceiling');
        this.ground19.scale.y = 0.525;
        
        this.elevator = this.walls.create(440, 345, 'floor');
        this.elevator.scale.x = 0.3;
        
        this.pressureplate = this.buttons.create(475, 335, 'buttonGround');
        this.pressureplate.scale.y = 0; //this will change to 1 after hitting switch2
        this.pressureplateBase = this.buttons.create(475, 340, 'buttonBase');
        //player sprite
        //this.player = game.add.sprite(200, 340, 'player');
        //this.player.anchor.setTo(0.5, 0.5);
        
        this.player = this.game.add.sprite(200, 16, 'rick');
        ...
        this.door = game.add.sprite(465, 25, 'door');
        ...
        this.enemy1 = this.enemies.create(40, 275, 'enemy');
        this.enemy1.frame = 20;
        this.enemy1RightArm = game.add.sprite(236, 75, 'enemyRightArm');
        this.enemy1LeftArm = game.add.sprite(236, 75, 'enemyLeftArm');
        this.enemy1RightArm.frame = 1;
        this.enemy1LeftArm.frame = 1;
        this.enemy2 = this.enemies.create(340, 530, 'enemy');
        this.enemy2.frame = 0;
        this.enemy2RightArm = game.add.sprite(340, 570, 'enemyRightArm');
        this.enemy2LeftArm = game.add.sprite(340, 570, 'enemyLeftArm');
        this.enemy2RightArm.frame = 0;
        this.enemy2LeftArm.frame = 0;
        this.enemy3 = this.enemies.create(712, 20, 'enemy');
        this.enemy3.frame = 0;
        this.enemy3RightArm = game.add.sprite(712, 75, 'enemyRightArm');
        this.enemy3LeftArm = game.add.sprite(712, 75, 'enemyLeftArm');
        this.enemy3RightArm.frame = 1;
        this.enemy3LeftArm.frame = 1;
        this.enemy4 = this.enemies.create(900, 453, 'enemy');
        this.enemy4.frame = 0;
        this.enemy4RightArm = game.add.sprite(719, 453, 'enemyRightArm');
        this.enemy4LeftArm = game.add.sprite(719, 453, 'enemyLeftArm');
        this.enemy4RightArm.frame = 1;
        this.enemy4LeftArm.frame = 1;
        ...
        this.blockingWalls = [
            ...
            this.blockingWall5 = new Phaser.Line(this.ground9.x, this.ground9.y, this.ground9.x+this.ground9.width, this.ground9.y),
            this.blockingWall6 = new Phaser.Line(this.ground10.x, this.ground10.y, this.ground10.x+this.ground10.width, this.ground10.y),
            this.blockingWall7 = new Phaser.Line(this.ground11.x, this.ground11.y, this.ground11.x+this.ground11.width, this.ground11.y),
            this.blockingWall8 = new Phaser.Line(this.ground12.x, this.ground12.y, this.ground12.x+this.ground12.width, this.ground12.y),
            this.blockingWall9 = new Phaser.Line(this.ground13.x, this.ground13.y, this.ground13.x+this.ground13.width, this.ground13.y),
            this.blockingWall10 = new Phaser.Line(this.ground14.x, this.ground14.y, this.ground14.x+this.ground14.width, this.ground14.y),
            this.blockingWall11 = new Phaser.Line(this.ground15.x, this.ground15.y, this.ground15.x+this.ground15.width, this.ground15.y),
            this.blockingWall12 = new Phaser.Line(this.ground16.x, this.ground16.y, this.ground16.x+this.ground16.width, this.ground16.y),
            this.blockingWall13 = new Phaser.Line(this.ground17.x, this.ground17.y, this.ground17.x+this.ground17.width, this.ground17.y),
            this.blockingWall14 = new Phaser.Line(this.ground18.x, this.ground18.y, this.ground18.x, this.ground18.y+this.ground18.height),
            this.blockingWall15 = new Phaser.Line(this.ground19.x, this.ground19.y, this.ground19.x, this.ground19.y+this.ground19.height),
            ];
    ...
    update: function() {
        ...
        this.enemy4RightArm.rotation = game.physics.arcade.angleBetween(this.enemy4RightArm, this.playerMidPoint);
        this.enemy4LeftArm.rotation = game.physics.arcade.angleBetween(this.enemy4LeftArm, this.playerMidPoint);
        
        if(this.elevator.y <= 97){
        ...
        if(this.player.x < this.enemy4.x){
            this.enemy4.frame = 20;
            this.enemy4RightArm.frame = 1;
            this.enemy4LeftArm.frame = 1;
            this.enemy4RightArm.x = this.enemy4.x+35;
            this.enemy4RightArm.y = this.enemy4.y+11;
            this.enemy4LeftArm.x = this.enemy4.x+35;
            this.enemy4LeftArm.y = this.enemy4.y+11;
            this.enemy4RightArm.anchor.setTo(0.1, 0.9);
            this.enemy4LeftArm.anchor.setTo(0.1, 0.9);
        }
        else{
            this.enemy4.frame = 0;
            this.enemy4RightArm.frame = 0;
            this.enemy4LeftArm.frame = 0;
            this.enemy4RightArm.x = this.enemy4.x+28;
            this.enemy4RightArm.y = this.enemy4.y+12;
            this.enemy4LeftArm.x = this.enemy4.x+28;
            this.enemy4LeftArm.y = this.enemy4.y+12;
            this.enemy4RightArm.anchor.setTo(0.1, 0.1);
            this.enemy4LeftArm.anchor.setTo(0.1, 0.1);
        }
        ...
        if(!this.enemy4.alive){
            this.enemy4RightArm.kill();
            this.enemy4LeftArm.kill();
        }
    ...
    enemyFire: function(enemy, playerPoint){
        if (game.time.now > this.nextEnemyShotAt && this.enemyBullets.countDead() > 0){
             ...
             this.game.physics.arcade.moveToXY(this.enemyBullet, playerPoint.x, playerPoint.y, 60, 750);
