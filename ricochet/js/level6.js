var level6State = {
    create: function() { 
        ...
        this.ground5 = this.walls.create(0, 584, 'floor');
        this.ground5.scale.x = 1.1;
        this.ground6 = this.walls.create(576, 584, 'floor');
        this.ground6.scale.x = 1.1;
        this.ground7 = this.walls.create(0, 0, 'floor');
        this.ground7.scale.x = 1.1;
        this.ground8 = this.walls.create(576, 0, 'floor');
        this.ground8.scale.x = 1.1;
        
        this.ground9 = this.transparentWalls.create(16, 167, 'glassPane');
        this.ground10 = this.transparentWalls.create(774, 167, 'glassPane');
        
        this.door = game.add.sprite(936, 515, 'door');
        this.door.animations.add('doorOpen', [0, 1, 2, 3], 64, false);
        this.door.animations.add('doorClose', [3, 2, 1, 0], 64, false);
        
        this.fallingBlock1 = this.fallingBlocks.create(450, 0, 'floor');
        this.fallingBlock1.scale.x = .3;
        this.fallingBlock1.scale.y = 2.5;
        
        this.fallingBlock2 = this.fallingBlocks.create(450, 208, 'floor');
        this.fallingBlock2.scale.x = .3;
        this.fallingBlock2.scale.y = 2.5;
        
        this.fallingBlock3 = this.fallingBlocks.create(450, 416, 'floor');
        this.fallingBlock3.scale.x = .3;
        this.fallingBlock3.scale.y = 2.5;
        
        this.pressureplate = this.buttons.create(880, 575, 'buttonGround');
        this.pressureplate.scale.y = 0; //this will change to 1 after hitting switch2
        this.pressureplateBase = this.buttons.create(880, 580, 'buttonBase');
        //player sprite
        ...
        this.enemy1 = this.enemies.create(32, 80, 'enemy');
        this.enemy1.frame = 20;
        this.enemy1RightArm = game.add.sprite(800, 200, 'enemyRightArm');
        this.enemy1LeftArm = game.add.sprite(800, 200, 'enemyLeftArm');
        this.enemy1RightArm.frame = 1;
        this.enemy1LeftArm.frame = 1;
        this.enemy2 = this.enemies.create(900, 80, 'enemy');
        this.enemy2.frame = 0;
        this.enemy2RightArm = game.add.sprite(300, 0, 'enemyRightArm');
        this.enemy2LeftArm = game.add.sprite(200, 0, 'enemyLeftArm');
        ...
        game.physics.arcade.enable(this.fallingBlocks);
        ...
        //Falling Blocks
        this.fallingBlocks.enableBody = true;
        this.fallingBlocks.physicsBodyType = Phaser.Physics.ARCADE;
        this.fallingBlocks.setAll('body.immovable', true);
        this.fallingBlocks.setAll('body.allowGravity', false);
    ...
    update: function() {
        ...
        for (i = 0; i < this.fallingBlocks.length; i++){
            this.fallingBlocks.children[i].body.velocity.y = 50;
        }
        if (this.fallingBlock1.y >= 616){
            this.fallingBlock1.kill();
            this.fallingBlock1 = this.fallingBlocks.create(450, 0, 'floor');
            this.fallingBlock1.scale.x = .3;
            this.fallingBlock1.scale.y = 2.5;
            this.fallingBlock1.enableBody = true;
            this.fallingBlock1.physicsBodyType = Phaser.Physics.ARCADE;
            this.fallingBlock1.body.immovable = true;
            this.fallingBlock1.body.allowGravity = false;
        }
        if (this.fallingBlock2.y >= 616){
            this.fallingBlock2.kill();
            this.fallingBlock2 = this.fallingBlocks.create(450, 0, 'floor');
            this.fallingBlock2.scale.x = .3;
            this.fallingBlock2.scale.y = 2.5;
            this.fallingBlock2.enableBody = true;
            this.fallingBlock2.physicsBodyType = Phaser.Physics.ARCADE;
            this.fallingBlock2.body.immovable = true;
            this.fallingBlock2.body.allowGravity = false;
        }
        if (this.fallingBlock3.y >= 616){
            this.fallingBlock3.kill();
            this.fallingBlock3 = this.fallingBlocks.create(450, 0, 'floor');
            this.fallingBlock3.scale.x = .3;
            this.fallingBlock3.scale.y = 2.5;
            this.fallingBlock3.enableBody = true;
            this.fallingBlock3.physicsBodyType = Phaser.Physics.ARCADE;
            this.fallingBlock3.body.immovable = true;
            this.fallingBlock3.body.allowGravity = false;
        }
        ...
        this.game.physics.arcade.overlap(this.enemyBullets, this.fallingBlocks, this.killEnemyBullets, null, this);
        //this.game.physics.arcade.collide(this.player, this.colliders);
        this.game.physics.arcade.collide(this.bullets, this.fallingBlocks, this.hitWall, null, this);
        this.game.physics.arcade.collide(this.player, this.fallingBlocks);
    ...
    killEnemyBullets: function(){
        ...
        for (var i = 0; i < this.enemyBullets.children.length; i++){
            ...
            else if(this.checkOverlap(this.enemyBullets.children[i], this.fallingBlocks)){
                this.enemyBullets.callAll('kill');
            }
        }   
    },
