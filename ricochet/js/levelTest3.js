var level3TestState = {
    ...
    update: function() {
        ...
        if (this.ground9.x >= 175 && this.switchOn == true){
            this.ground9.body.velocity.x = 0;
        }
        
        if (this.ground9.x <= -100 && this.switchOn == false){
            this.ground9.body.velocity.x = 0;
        }
    ...
    activateSwitch1: function(){
        ...
        if (this.switchOn == false){
            ...
            //var platformTween = game.add.tween(this.ground5).to({x:500,y:220},1000);
            //platformTween.start();
            this.switchOn = true;
        }
            ...
            this.ground9.body.velocity.x = -40;
            //var platformTween2 = game.add.tween(this.ground5).to({x:500,y:520},1000);
