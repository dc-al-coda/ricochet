var BaseLevelEnemiesState = {
    create: function() { 
        ...
        this.ground5 = this.walls.create(800, 300, 'floor');
        this.ground6 = this.walls.create(-50, 200, 'floor');
        this.ground7 = this.walls.create(100, 400, 'ceiling');
        ...
        this.enemy3.frame = 0;
        this.enemy3RightArm = game.add.sprite(50, 500, 'enemyRightArm');
        this.enemy3LeftArm = game.add.sprite(50, 500, 'enemyLeftArm');
